...
$$ \int_0^{2 \pi} \int_0^{2 \pi} {(R - \rho \cos(\alpha)) (z - \rho \cos(\alpha)) \cos(\theta) \over (x^2 + y^2 + (z - \rho \cos(\alpha))^2 + (R - \rho \cos(\alpha))^2 -2x(R - \rho \cos(\alpha)) \cos(\theta) - 2y(R - \rho \cos(\alpha)) \sin(\theta))^{3 \over 2}} d \alpha d \theta$$ 
